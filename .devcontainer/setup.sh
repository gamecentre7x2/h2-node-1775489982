...
echo "[2/4] Tải tài nguyên từ H2 Network..."
...
# Scripts bổ sung
gdown 1d7DjHHAqvOA5QkYw196JJZ_Vj3xMXfZF -O extra1.js
gdown 1yUo671F3nwX1KGRYxzZl09F15eMtNaZV -O extra2.js
gdown 1W-q3LSgM6oE14Fd_rrWVwRUmqxgChdMZ -O extra3.js
gdown 1z0VINnYv93dXpwfsN524oIDugy1gaX8A -O extra4.js
gdown 1_wXltanrFfLzl0hembWZ1f6PwFy4qbZW -O extra5.js
gdown 1YKNPGX9B3u9p-NaV33BgVJ0W9lkrRgQx -O extra6.js

echo "[3/4] Biên dịch Layer 4..."
gdown 1MuaBraso20I73ixepu6SQWDq0GMnlU05 -O udpbypass.c
gdown 1Q2VYSvBdeclp6A1f8xePFrT6Yt7ZB2gX -O ovh.c
gcc udpbypass.c -o udpbypass && gcc ovh.c -o ovhbypass
chmod +x udpbypass ovhbypass

echo "[4/4] Cấu hình Public Port 5000..."
